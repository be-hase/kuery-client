 ...
 * [MySqlDuplicateKeyContract]) must surface as Spring's DataIntegrityViolationException so that
 * callers can catch them in their use-case layer.
 */
abstract class MySqlDataIntegrityViolationContract {
