...
Genuinely one-sided behavior (Reactor context on r2dbc, `Sequence` / `maxRows` / `queryTimeoutSeconds` on jdbc, transactions) stays as plain tests in the owning module.
