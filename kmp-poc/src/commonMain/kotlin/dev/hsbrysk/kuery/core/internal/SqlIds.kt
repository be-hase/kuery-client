...
// PoC note: `@JvmField` removed from `sqlId` — kotlin.jvm.JvmField does not resolve in
// Kotlin/Native compilations (confirmed by this PoC; the JVM-only metadata compilation accepted
// it). A real KMP conversion must drop it or keep this class JVM-only.
