...
import dev.hsbrysk.kuery.spring.testing.contract.conversion.ConverterRegistrationContract

class ConverterRegistrationTest : ConverterRegistrationContract() {
